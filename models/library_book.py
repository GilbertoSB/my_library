...
class LibraryBook(models.Model):
  ...
  short_name = fields.Char('Short Title', required=True, help="Texto que se usara para referirse al libro")
  notes = fields.Text('Internal Notes')
  state = fields.Selection(string='State', selection=[('draft', 'Unavailable'),
                                                      ('available', 'Available'),
                                                      ('borrowed', 'Borrowed'),
                                                      ('lost', 'Lost'), ],
                                                      default='draft')
  ...
  cost_price = fields.Float('Book Cost', digits='Book_Price')
  ...
  age_days = fields.Float(string='Days Since Release', compute='_compute_age', inverse='_inverse_age',
                          search='_search_age', store=False)  # optional compute_sudo=True  # optional
  ...
  def change_release_date(self):
    ...
    self.update({'date_release': fields.Datetime.now()})
